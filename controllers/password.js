...
exports.postForgotPassword = async (req,res,next) =>{
    ...
    try{
        ...
        let url = `http://16.171.14.149:3000/password/resetpassword/${uuidv4}`;
        ...
        await tranEmailApi.sendTransacEmail({
            ...
            htmlContent : `<a href="http://16.171.14.149:3000/password/resetpassword/${uuidv4}">reset password</a>`
        })
        .then(data=>{
            console.log(data);
