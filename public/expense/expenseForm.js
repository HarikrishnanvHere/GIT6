...
function displayElement(expense){
    ...
    deleteButton.addEventListener("click",()=>{
        let url = `http://16.171.14.149:3000/expense/deleteexpense/${expense.id}`;
...
function fetchExpenses(page){
    ...
    axios.get(`http://16.171.14.149:3000/expense/getexpense?page=${page}&pageSize=${pageSize}`,{headers: {"authorization": token}})
    .then((res)=>{
        //console.log(res);
...
function addExpense(e){
    ...
    axios.post("http://16.171.14.149:3000/expense/addexpense",obj,{headers: {"authorization": token}})
...
document.getElementById('premium').onclick = async function (event) {
        ...
        const response = await axios.get("http://16.171.14.149:3000/purchase/purchasepremium", { headers: { "authorization": token } })
        ...
        const options = {
            ...
            "handler": async function (response) {
                    //console.log(response);
                    await axios.post("http://16.171.14.149:3000/purchase/updatetransactionstatus", {
...
document.getElementById("leaderboard").onclick = async function(){
    axios.get("http://16.171.14.149:3000/premium/showleaderboard")
...
document.getElementById("download").onclick = async ()=>{
    await axios.get("http://16.171.14.149:3000/expense/download",{headers: {"authorization": token}})
    .then((response)=>{
        console.log(response);
